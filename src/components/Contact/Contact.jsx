          ...
          <div className="inner rounded-2 contact-border ">
            ...
            <form className="row g-3 pt-5  ">
              <div className="col-md-6">
                ...
                <input
                  type="text"
                  className="shadow-none form-control px-3  border-0  "
                  id="inputName4"
                />
              </div>
              <div className="col-md-6">
              ...
              <div className="col-12">
                <label htmlFor="yourMessage" class="form-label">
                  Your message
                </label>
                <textarea
                  class="form-control shadow-none  px-3 border-0  "
                  id="yourMessage "
                  rows={4}
                ></textarea>
              </div>
              <div className="col-12">
                <button
                  type="submit"
                  className="btn btn-primary btn-sm fw-medium  border-0"
                >
                  Send Message
                </button>
              </div>
